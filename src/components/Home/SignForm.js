            ...
            <div className="col-md-6 col-sm-6 col-xs-12">
              ...
              <div className="text-center">
                <ButtonGroup>
                  ...
                  <Button
                    className="light-form-button"
                    active={this.state.signinVisible}
                    color="primary"
            ...
            <div className="col-md-6 col-sm-6 col-xs-12">
              <div className="row">
                ...
                <div className="col-md-6 col-sm-6">
                  <div className="service-box text-center">
                    <div className="icon-box">
                      <i className="fa fa-thumbs-o-up color-green" />
                    </div>
                ...
                <div className="col-md-6 col-sm-6">
                  <div className="service-box text-center">
                    <div className="icon-box">
                      <i className="fa fa-universal-access color-green" />
                    </div>
                    <div className="icon-text">
                ...
                <div className="col-md-6 col-sm-6">
                  <div className="service-box text-center">
                    <div className="icon-box">
                      <i className="fa fa-space-shuttle color-green" />
                    </div>
                    <div className="icon-text">
                ...
                <div className="col-md-6 col-sm-6">
                  <div className="service-box text-center">
                    <div className="icon-box">
                      <i className="fa fa-trophy color-green" />
                    </div>
                    <div className="icon-text">
