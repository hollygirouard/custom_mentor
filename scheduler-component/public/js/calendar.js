$(document).ready(function(){
  // let apiUrl = "https://apis.google.com/js/api.js";
  let authorizeButton = document.getElementById('authorize-button');
  let signoutButton = document.getElementById('signout-button');
  // console.log(authorizeButton);
  // let body = document.getElementsByTagName('body');
  // console.log(body);
  // let buttonsDiv = document.getElementsByClassName('buttons-div');
  // console.log(buttonsDiv);

  //make an empty div

  // $('.buttons-div').append('<button id=“authorize-button” style=“display: none;“>Authorize</button>');
  //add a btn bootstrap button with class button
  //add our classes for authorize and signout
...
/* --------------------------oauth functions from Google -------------------------- */
  /**
   *  On load, called to load the auth2 library and API client library.
   */
  function handleClientLoad(authorizeButton, signoutButton) {
    gapi.load("client:auth2", function() {
      console.log(authorizeButton);
      initClient(authorizeButton, signoutButton);
    });
  }
   ...
   *  listeners.
   */
  function initClient(authorizeButton, signoutButton) {
    console.log(authorizeButton);
    gapi.client.init({
      ...
      gapi.auth2.getAuthInstance().isSignedIn.listen(function() {
        updateSigninStatus(isSignedIn, authorizeButton, signoutButton);
      });

     // Handle the initial sign-in state.
     let isSignedInVariable = gapi.auth2.getAuthInstance().isSignedIn.get();
      updateSigninStatus(isSignedInVariable, authorizeButton, signoutButton);
   ...
   */
  function updateSigninStatus(isSignedIn, authorizeButton, signoutButton) {
    if (isSignedIn) {
